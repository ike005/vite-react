        ...
        <div className="flex flex-col gap-[7rem] items-center justify-center h-screen">
            ...
            <div className="flex flex-col gap-2 items-center text-center">
                <h1 className="text-4xl font-bold">
                    Ask your concerning questions for <span className="text-[#13ec49]">Insight</span>
                </h1>
                <p className="text-gray-500 text-xl font-medium">
                    Get instant answer powered by AI
                </p>
            </div>
            ...
            <div className="flex flex-col gap-[3rem] items-center">
                <div>
                    ...
                    <div className="flex items-center justify-between bg-white shadow-xl rounded-xl w-[43rem] px-4 py-3">
                        ...
                        <button
                            onClick={askAI}
                            className="flex items-center gap-2 bg-[#13ec49] px-5 py-2 rounded-xl"
                        >
                ...
                <div>
                    ...
                    <div className="flex gap-4 items-start rounded-xl w-[43rem] p-6 bg-white shadow-xl min-h-[10rem]">
